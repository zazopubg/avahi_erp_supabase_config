...
/// زرَّا اعتماد/رفض تقرير مُقدَّم — `report_review_screen.dart`. الرفض
/// يفتح حواراً وسيطاً لطلب سبب الرفض (إلزامي) قبل تأكيد الاستدعاء
/// الفعلي؛ الاعتماد فوري بلا حوار وسيط.
class ReportApprovalActions extends StatelessWidget {
  const ReportApprovalActions({
        ...
        return AlertDialog(
          ...
          content: Form(
            ...
            child: AvahiTextField(
              ...
              label: 'اذكر سبب رفض هذا التقرير',
              maxLines: 3,
              minLines: 2,
              autofocus: true,
